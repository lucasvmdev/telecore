defmodule TelecoreWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-lg relative hidden rounded-2xl bg-base-100 p-8 ring-1 ring-base-300 transition"
            >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TelecoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TelecoreWeb.Gettext, "errors", msg, opts)
    end
  end
